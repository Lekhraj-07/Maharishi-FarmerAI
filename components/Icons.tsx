...
export const LeafIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M20 6.2c-1.5-1.5-3-2-4.5-2-1.5 0-3 .5-4.5 2-1.5-1.5-3-2-4.5-2-1.5 0-3 .5-4.5 2C1 7.7 1 10.2 1 12c0 2.5 2 5 2 5s2-2.5 2-5c0-1.5 1.5-3 3-3s3 1.5 3 3-1.5 3-3 3c0 1.5-1.5 2.5-3 3" />
    </svg>
);
